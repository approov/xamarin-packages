...
namespace Refit
{
    public static class RestService
    {
        ...
        public static T For<T>(ApproovHttpClient client, IRequestBuilder<T> builder)
        {
        ...
        /// <returns>An instance that implements <typeparamref name="T"/>.</returns>
        public static T For<T>(ApproovHttpClient client, RefitSettings? settings)
        {
        ...
        /// <param name="client">The <see cref="HttpClient"/> the implementation will use to send requests.</param>
        /// <returns>An instance that implements <typeparamref name="T"/>.</returns>
        public static T For<T>(ApproovHttpClient client) => For<T>(client, (RefitSettings?)null);
        ...
        public static object For(Type refitInterfaceType, ApproovHttpClient client, IRequestBuilder builder)
        {
        ...
        /// <param name="settings"><see cref="RefitSettings"/> to use to configure the HttpClient.</param>
        /// <returns>An instance that implements <paramref name="refitInterfaceType"/>.</returns>
        public static object For(Type refitInterfaceType, ApproovHttpClient client, RefitSettings? settings)
        {
        ...
        /// <param name="client">The <see cref="HttpClient"/> the implementation will use to send requests.</param>
        /// <returns>An instance that implements <paramref name="refitInterfaceType"/>.</returns>
        public static object For(Type refitInterfaceType, ApproovHttpClient client) => For(refitInterfaceType, client, (RefitSettings?)null);
        ...
        /// <param name="refitInterfaceType">Interface to create the implementation for.</param>
        /// <param name="hostUrl">Base address the implementation will use.</param>
        /// <param name="settings"><see cref="RefitSettings"/> to use to configure the ApproovHttpClient.</param>
        /// <returns>An instance that implements <paramref name="refitInterfaceType"/>.</returns>
        ...
        public static ApproovHttpClient CreateHttpClient(string hostUrl, RefitSettings? settings)
        {
            ...
            return new ApproovHttpClient(innerHandler ?? new HttpClientHandler()) { BaseAddress = new Uri(hostUrl.TrimEnd('/')) };
        }
