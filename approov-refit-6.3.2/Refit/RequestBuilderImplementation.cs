...
namespace Refit
{
    ...
    partial class RequestBuilderImplementation : IRequestBuilder
    {
        ...
        Func<ApproovHttpClient, CancellationToken, object[], Task<T?>> BuildCancellableTaskFuncForMethod<T, TBody>(RestMethodInfo restMethod)
        {
            return async (client, ct, paramList) =>
            {
                if (client.BaseAddress == null)
                    throw new InvalidOperationException("BaseAddress must be set on the ApproovHttpClient instance");
...
#pragma warning restore IDE1006 // Naming Styles
                ...
                if (headersToAdd.Count > 0)
                {
                    ...
                    // provided the ApproovHttpClient will allow it for the method
        ...
        Func<ApproovHttpClient, object[], IObservable<T?>> BuildRxFuncForMethod<T, TBody>(RestMethodInfo restMethod)
        {
        ...
        Func<ApproovHttpClient, object[], Task<T?>> BuildTaskFuncForMethod<T, TBody>(RestMethodInfo restMethod)
        {
        ...
        Func<ApproovHttpClient, object[], Task> BuildVoidTaskFuncForMethod(RestMethodInfo restMethod)
        {
