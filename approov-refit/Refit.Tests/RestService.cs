...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public class RestServiceIntegrationTests
    {
        ...
        public async Task BaseAddressFromHttpClientMatchesTest()
        {
            ...
            var client = new ApproovHttpClient(mockHttp)
            {
        ...
        public async Task DoesntAddAutoAddContentToGetRequest()
        {
            ...
            mockHttp.Expect(HttpMethod.Get, "http://foo/nobody")
                ...
                // because ApproovHttpClient doesn't allow it and it will
                // blow up at runtime
        ...
        public async Task TwoSubscriptionsResultInTwoRequests()
        {
            ...
            var client = new ApproovHttpClient(input) { BaseAddress = new Uri("http://foo") };
...
#pragma warning restore CS0618
        ...
        public async Task ValueTypesArentValidButTheyWorkAnyway()
        {
            ...
            var fixture = RestService.For<IBrokenWebApi>(new ApproovHttpClient(handler) { BaseAddress = new Uri("http://nowhere.com") });
        ...
        {
            var client = new ApproovHttpClient(); // No BaseUrl specified
