...
namespace Refit.Tests
{
    public class InterfaceStubGeneratorTests
    {
        ...
        {
#if NET5_0
            ReferenceAssemblies = ReferenceAssemblies.Default.AddPackages(ImmutableArray.Create(new PackageIdentity("ApproovHttpClient", "1.0.8")));
#else
            ...
            ReferenceAssemblies = ReferenceAssemblies
                ...
                .AddPackages(ImmutableArray.Create(new PackageIdentity("ApproovHttpClient", "1.0.8")));
#endif
        }
...
namespace Refit.Implementation
{
    ...
    {
        /// <inheritdoc />
        public global::Approov.ApproovHttpClient Client { get; }
        readonly global::Refit.IRequestBuilder requestBuilder;

        /// <inheritdoc />
        public RefitTestsIGitHubApi(global::Approov.ApproovHttpClient client, global::Refit.IRequestBuilder requestBuilder)
        {
            Client = client;
...
namespace Refit.Implementation
{
...

    {
        ...
        /// <inheritdoc />
        public RefitTestsIGitHubApiDisposable(global::Approov.ApproovHttpClient client, global::Refit.IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
...
namespace Refit.Implementation
{
...

    {
        ...
        /// <inheritdoc />
        public RefitTestsTestNestedINestedGitHubApi(global::Approov.ApproovHttpClient client, global::Refit.IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
...
namespace Refit.Implementation
{
...

    {
        ...
        /// <inheritdoc />
        public IServiceWithoutNamespace(global::Approov.ApproovHttpClient client, global::Refit.IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
