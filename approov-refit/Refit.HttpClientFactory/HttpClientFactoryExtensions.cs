    ...
    public static class HttpClientFactoryExtensions
    {
        ...
        public static IHttpClientBuilder AddRefitClient<T>(this IServiceCollection services, RefitSettings settings = null) where T : class
        {
            ...
            return services.AddHttpClient(UniqueName.ForType<T>())
                           ...
                           .AddTypedClient((client, serviceProvider) => RestService.For<T>((ApproovHttpClient)client, serviceProvider.GetService<IRequestBuilder<T>>()));
        }
        ...
        private static IHttpClientBuilder AddTypedClient(this IHttpClientBuilder builder, Type type, Func<ApproovHttpClient, IServiceProvider, object> factory)
        {
            if (builder == null)
            {
            ...
            builder.Services.AddTransient(type, s =>
            {
                ...
                return factory((ApproovHttpClient)httpClient, s);
            });
